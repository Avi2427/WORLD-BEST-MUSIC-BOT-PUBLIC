...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    try {
      ...
      message.guild.channels.create("KURUVI'S REQUEST", {
          type: 'category',
        ...
        .then((channel1) => {
          try {
            ...
            message.guild.channels.create(`​🎸｜Music`, {
              ...
              .then((channel2) => {
                try {
                  message.guild.channels.create(`🎵｜Request Music Here`, {
                    ...
                    .then(async (channel3) => {
                      let embed1 = new MessageEmbed()
                        ...
                        .setTitle("Kuruvi Music | Request | Guide")
                      ...
                      let embed2 = new MessageEmbed()
                        .setColor(ee.color)
                        .setFooter(ee.footertext, ee.footericon)
                        .setTitle("Kuruvi Music | Music Queue")
                        .setDescription(`Empty\nJoin a voice channel and queue songs by name or url in here.`)
                      let embed3 = new MessageEmbed()
                        .setColor(ee.color)
                        .setFooter(ee.footertext, ee.footericon)
                        .setTitle("Kuruvi Music | Currently no song is playing!")
                        ...
                        .setImage("http://www.simpleimageresizer.com/_uploads/photos/8ecb2418/KURUVI_2_400x255.gif")
                      //send a temp message
